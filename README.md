...
This repository contains hands-on DevSecOps assignments focused on integrating security into the CI/CD pipeline using industry-standard tools.
...
* Security tools integrated into pipelines
* Automated vulnerability scanning on code push
* Reports generated for auditing and analysis
...
These tools and practices are widely used in enterprise environments to:
